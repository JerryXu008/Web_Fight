...
$(function () {
  ...
  let ids = [];
 //如果服务端没有数据，启用这个
 // songArray=[{id:100001,name:"呵呵",singer:"苏红民"},{id:108914,name:"江南",singer:"林俊杰"}];
        ...
        mySwiper = new Swiper ('.swiper-container', {
          ...
          on: {
            slideChangeTransitionEnd: function(){
              console.log("切换了",this.realIndex);
...
$(".main-in").click(function () {
  ...
  if($(this).hasClass("active")){
   // songArray[index].id = "100001";
   if(songArray[index].id){
...
lyricScroll.on("scroll", function () {
  ...
  if(!cur$li[0]) return;
  $(".lyric-time-line>span").text( cur$li[0].lrc ? cur$li[0].lrc.timeStr:"");
