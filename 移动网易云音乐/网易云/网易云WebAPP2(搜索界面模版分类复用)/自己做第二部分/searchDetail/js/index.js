$(function () {
  ...
  function initHeader(){
    let keyword;
    if((window.location.href.lastIndexOf("keyword="))!=-1){
       keyword = window.location.href.substring(window.location.href.lastIndexOf("keyword=") + "keyword=".length);
...
// 5.初始化默认界面
  ...
  //  // 监听多选按钮点击
  //  $(".multiple-select").click(function () {
  //    $(".song>.top").addClass("active");
  //    $(".song>.list").addClass("active");
  //  });
  //  // 监听完成按钮点击
  //  $(".complete-select").click(function () {
  //    $(".song>.top").removeClass("active");
  //    $(".song>.list").removeClass("active");
  //  });
  //  // 监听全选按钮点击
  //  $(".check-all").click(function () {
  //    $(this).toggleClass("active");
  //    $(".song>.list>li").toggleClass("active");
  //  });
  //
  //  // 处理单曲界面的头部
  //  myScroll.on("scroll", function () {
